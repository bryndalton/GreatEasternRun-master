...
;(function($) {
  ...
  $.fn.bxSlider = function(options) {
    ...
    var appendControls = function() {
      slider.controls.next = $('<a class="bx-next" href="" aria-label="Next">' + slider.settings.nextText + '</a>');
      slider.controls.prev = $('<a class="bx-prev" href="" aria-label="Previous">' + slider.settings.prevText + '</a>');
